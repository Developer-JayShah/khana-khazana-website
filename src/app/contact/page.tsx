            ...
            <div className="overflow-hidden rounded-2xl border border-[var(--color-border)] bg-white shadow-sm">
              ...
              <div className="divide-y divide-[var(--color-border)]">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-3 px-6 py-4 text-sm text-[var(--color-muted)] transition hover:text-[#1877F2]"
                >
                ...
                <a
                  href="https://www.instagram.com/khana_khazana1760"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-3 px-6 py-4 text-sm text-[var(--color-muted)] transition hover:text-[#E1306C]"
                >
                  <div className="flex h-9 w-9 items-center justify-center rounded-full bg-[#E1306C]/10">
